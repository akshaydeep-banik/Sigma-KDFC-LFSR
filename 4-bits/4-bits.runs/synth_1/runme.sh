...
HD_PWD='E:/8-IITG Summer Internship/3-Verilog Files/4-bits/4-bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ConfrigurationMatrix.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ConfrigurationMatrix.tcl
