...
HD_PWD='E:/8-IITG Summer Internship/3-Verilog Files/4-bits/4-bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ConfrigurationMatrix.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ConfrigurationMatrix.tcl -notrace
